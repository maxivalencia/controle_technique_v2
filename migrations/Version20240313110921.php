 ...
 */
final class Version20240313110921 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ct_motif_tarif (id INT AUTO_INCREMENT NOT NULL, ct_motif_id_id INT DEFAULT NULL, ct_arrete_prix_id INT DEFAULT NULL, mtf_trf_prix DOUBLE PRECISION NOT NULL, mtf_trf_date DATE NOT NULL, INDEX IDX_110F10F876255A68 (ct_arrete_prix_id), INDEX IDX_110F10F8603A0766 (ct_motif_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE ct_autre_vente_ct_visite_extra (ct_autre_vente_id INT NOT NULL, ct_visite_extra_id INT NOT NULL, INDEX IDX_38C3E3BC15D88434 (ct_visite_extra_id), INDEX IDX_38C3E3BC8D1D5C87 (ct_autre_vente_id), PRIMARY KEY(ct_autre_vente_id, ct_visite_extra_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE ct_droit_ptac (id INT AUTO_INCREMENT NOT NULL, ct_genre_categorie_id_id INT DEFAULT NULL, ct_type_droit_ptac_id_id INT DEFAULT NULL, ct_arrete_prix_id_id INT DEFAULT NULL, dp_prix_min DOUBLE PRECISION DEFAULT NULL, dp_prix_max DOUBLE PRECISION DEFAULT NULL, dp_droit DOUBLE PRECISION NOT NULL, INDEX IDX_DB918ADA5FFCB50 (ct_type_droit_ptac_id_id), INDEX IDX_DB918ADA2BD53E47 (ct_arrete_prix_id_id), INDEX IDX_DB918ADA3BEDFDD8 (ct_genre_categorie_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
