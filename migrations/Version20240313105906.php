 ...
 */
final class Version20240313105906 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ct_visite_ct_visite_extra (ct_visite_id INT NOT NULL, ct_visite_extra_id INT NOT NULL, INDEX IDX_F9CF011A15D88434 (ct_visite_extra_id), INDEX IDX_F9CF011A5314CD4 (ct_visite_id), PRIMARY KEY(ct_visite_id, ct_visite_extra_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
