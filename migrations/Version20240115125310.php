 ...
 */
final class Version20240115125310 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ct_arrete_prix (id INT AUTO_INCREMENT NOT NULL, ct_user_id_id INT DEFAULT NULL, art_numero VARCHAR(255) NOT NULL, art_date DATE DEFAULT NULL, art_date_application DATE DEFAULT NULL, art_created_at DATE NOT NULL, art_updated_at DATE DEFAULT NULL, art_observation VARCHAR(255) DEFAULT NULL, INDEX IDX_1CEB5E02E4B6E02 (ct_user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ct_autre (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, attribut VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ct_historique (id INT AUTO_INCREMENT NOT NULL, ct_user_id_id INT NOT NULL, ct_center_id_id INT DEFAULT NULL, ct_historique_type_id_id INT DEFAULT NULL, hst_description VARCHAR(255) NOT NULL, hst_date_created_at DATETIME NOT NULL, hst_is_view INT NOT NULL, INDEX IDX_7E72DEE1E4B6E02 (ct_user_id_id), INDEX IDX_7E72DEE1E2C56C4A (ct_center_id_id), INDEX IDX_7E72DEE1D2EF42B4 (ct_historique_type_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ct_user (id INT AUTO_INCREMENT NOT NULL, ct_centre_id_id INT DEFAULT NULL, ct_role_id_id INT DEFAULT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, usr_enable TINYINT(1) NOT NULL, usr_last_login DATETIME DEFAULT NULL, usr_mail VARCHAR(255) DEFAULT NULL, usr_nom VARCHAR(255) DEFAULT NULL, usr_adresse VARCHAR(255) DEFAULT NULL, usr_created_at DATETIME DEFAULT NULL, usr_updated_at DATETIME DEFAULT NULL, usr_telephone VARCHAR(255) DEFAULT NULL, usr_nbr_connexion INT DEFAULT NULL, UNIQUE INDEX UNIQ_A115979EF85E0677 (username), INDEX IDX_A115979E36C2F638 (ct_centre_id_id), INDEX IDX_A115979E1B557D75 (ct_role_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
