...
class CtConstatationEditType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $this->centre = $options["centre"];
        $carte_grise = $options['carte_grise'];
        $notice_descripive = $options['notice_descriptive'];
        $corps_vehicule = $options['corps_vehicule'];
        $etat = [
            'Oui' => true,
            'Non' => false
        ];
