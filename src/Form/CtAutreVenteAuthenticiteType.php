...
class CtAutreVenteAuthenticiteType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('lateral_arriere', ChoiceType::class, [
                'label' => 'latérale arrière',
                'choices' => $lateral_arriere,
                'data' => false,
                'mapped' => false,
            ])
            ->add('lateral_avant', ChoiceType::class, [
                'label' => 'latérale avant',
                'choices' => $lateral_avant,
                'data' => false,
                'mapped' => false,
            ])
            ->add('lunette_arriere', ChoiceType::class, [
                'label' => 'lunette arrière',
                'choices' => $lunette_arriere,
                'data' => false,
                'mapped' => false,
            ])
            ->add('pare_brise', ChoiceType::class, [
                'label' => 'pare-brise',
                'choices' => $pare_brise,
                'data' => false,
                'mapped' => false,
